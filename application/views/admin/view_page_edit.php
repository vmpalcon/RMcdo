...
<div class="content-header-breadcrumb">
        ...
        <div class="breadcrumb-item active"><a
                href="<?php echo base_url(); ?>admin/pages">Manage Pages</a>
        </div>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php echo form_open_multipart(base_url().'admin/pages/edit/'.$page_dynamic['id'], array('class' => 'form-horizontal'));?>
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            <?php if (file_exists(FCPATH.'public/uploads/'.$page_dynamic['banner'])) { ?>
                                <?php
