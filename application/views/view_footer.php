			...
			<div class="modal-header">
				<div>
					<a href="javascript:void(0)" class="btn-back"
						onclick="rckymcdo.backview(this)"><img src="<?php echo base_url(); ?>public/assets/img/svg/close.svg"
							alt="" /></a>
				</div>
						...
						<div>
							<div class="sendcode-input">
								<input type="text" id="username" name="username"
									class="username-field" placeholder="Username / Email" />
							</div>
							<div class="sendcode-input">
								<div>
							...
							<div class="login-btnfield">
								<button type="submit" 
									class="btn btn-primary submitloginbtn">Log
									in</button>
									<input type="hidden" name="form1" />
							</div>
						</div>
					</div>
					<div class="text-center mt-5 popsignupbtn">Don’t have an account? <a
							href="#">Sign
							up</a></div>
					<?php echo form_close(); ?>
				</div>
				...
				<?php echo form_open(base_url().'home/register'); ?>
					...
					<div class="registermsgoutput"></div>
						<div>
							...
							<div><select id ="month" name = "month" onchange="change_month(this)"></select></div>
							<div><select id ="day" name = "day" ></select></div>
							<div><select id ="year" name = "year" onchange="change_year(this)"></select></div>
							</div>
							<div class="sendcode-input">
								<input type="email" id="email" name="email"
									class="username-field" placeholder="Email" />
							</div>
							<div class="sendcode-input">
								<div>
					...
					<div class="text-center mt-5 poploginbtn">Already have an account? <a
							href="#">Log
							in</a></div>
					<?php echo form_close(); ?>		
				</div>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered">
         <div class="modal-content">
            <div class="modal-body">
               ...
               <div class="btn-alert red" onclick="rckymcdo.resetupload(this)"><a
                     href="#">Discard</a></div>
               <div class="btn-alert"><a href="#" data-bs-dismiss="modal"
                     aria-label="Close">Continue editing</a></div>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered">
         <div class="modal-content">
            <div class="modal-body">
               ...
               <div class="btn-alert red" onclick="rckymcdo.replacevideo(this)"><a
                     href="#">Replace</a>
               </div>
               <div class="btn-alert"><a href="#" data-bs-dismiss="modal"
                     aria-label="Close">Continue editing</a></div>
               ...
               <div class="rmc--photovideo-wrap">
                  <div class="rmc--photovideo-leftpane">
                     ...
                     <div class="rmc--photovideo-tool">
                        <a href="#" class="video-close" data-bs-dismiss="modal"
                           aria-label="Close"></a>
                  ...
                  <div class="rmc--photovideo-rightpane">
                     <div class="rmc-pv-btn-top"><a href="#"
                           class="btn btn-primary-outline">Follow</a></div>
                              ...
                              <div class="rmc--pvcomment-header">
                                 <div>
                                    <div class="rmc--profile-img"><a href="#"><img
                                             src="<?php echo base_url(); ?>public/assets/img/no-photo.jpg" alt=""></a>
                                    </div>
                                 </div>
                                 <div>
