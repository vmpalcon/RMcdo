!(function (e) {
  ...
  'use strict';
  var i = 'ccPicker',
    n = { countryCode: 'LT', dialCodeFieldName: 'phoneCode', dataUrl: 'data.json', countryFilter: !1, searchPlaceHolder: 'Search' };
  function r(t, o) {
    var c = this;
    return (
      (this.element = t),
  ...
  e.extend(r.prototype, {
    ...
    createCountryList: function (t) {
      var o = 'auto' === t._ccPicker.css('z-index') ? 9999 : Number(t._ccPicker.css('z-index')) + 10;
    ...
    selectCountry: function (t, o) {
      ...
      e(t.element).css('padding-left', t._ccPicker.width() + 56);
    },
    createCountryListItem: function (e, t) {
      return (
        '<div class="cc-picker-flag ' + e.toLowerCase() + '">' + e.toUpperCase() + '</div><span class="cc-picker-code">+' + t + '</span> '
      );
    },
  }),
    e.extend(e.expr[':'], {
    ...
    (e.fn.CcPicker = function (t) {
      if ('string' == typeof arguments[0]) {
        ...
        return (
          this.each(function () {
            if (!e.data(this, 'plugin_' + i) || 'function' != typeof e.data(this, 'plugin_' + i)[n])
